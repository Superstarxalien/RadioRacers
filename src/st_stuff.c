...
void ST_Drawer(void)
{
	...
	if (g_takemapthumbnail == TMT_NO)
	{
		...
		// Radio
		// I very much understand WHY this nag is here, just want to make it less apparent.
		V_DrawCenteredMenuString(BASEVIDWIDTH/2, 2, V_90TRANS|V_SNAPTOTOP, nag);

		V_DrawCenteredMenuString(BASEVIDWIDTH/2, BASEVIDHEIGHT - 10, V_90TRANS|V_SNAPTOBOTTOM, nag);
	}
